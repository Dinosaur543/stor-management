...
<div id="selection">
	 ...
	 <!-- // ---------------------------------------------- // -->
	<label id="title-h2">Expired report</label> 
	 <!-- // ---------------------------------------------- // -->	 
 	</div>
          ...
          <tr>
			...
			<form action="main.php?stt=expired-report" method="post" name="form1" id="form1" onsubmit="return chk_txt();" class="form-search">
...
<?php  
	$q="SELECT * FROM expired  Where (date(exp_date) BETWEEN '".$txtDate1."' AND '".$txtDate2."') ORDER BY exp_id Desc";  
