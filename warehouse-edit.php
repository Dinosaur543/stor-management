...
<!-- // ---------------------------------------------- // -->
<h2 id="title-txt">Add warehouse info</h2> <!-- warehouse tble -->
<!-- // ---------------------------------------------- // -->
...
?>
		...
		<label class="control-label">Ingredient </label>
			<div class="controls">
			<select name="wh_id_ingredient" id="txt">
		...
		<div class="control-group">
		<label class="control-label">Warehouse code</label> <!-- warehouse code -->
			<div class="controls">
			<input  type="text" id="txt" style="width: 100px;"  name="wh_code" value="<?=$wh_code?>"  />
			</div>
		</div>

		<div class="control-group">
		<label class="control-label">Warehouse name</label> <!-- ingredient name -->
			<div class="controls">
			<input  type="text" id="txt" style="width: 250px;"  name="wh_name" value="<?=$wh_name?>"  />
			</div>
		</div>
		...
		<label class="control-label">Price </label>
			<div class="controls">
			<input  type="text" id="txt" style="width: 100px;"  name="wh_price" value="<?=$wh_price?>"  />
			</div>
		</div>
		...
		<label class="control-label">Color </label>
			<div class="controls">
			<input  type="text" id="txt" style="width: 150px;"  name="wh_color" value="<?=$wh_color?>"  />
			</div>
		</div>
		...
		<label class="control-label">Exp date </label>
			<div class="controls">
			<input  type="date" id="txt" style="width: 150px;"  name="wh_date" value="<?=$wh_date?>"  />
			</div>
		</div> -->
