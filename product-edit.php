...
?>
		...
		<label class="control-label">Product code</label>
			<div class="controls">
			<input  type="text" id="txt" style="width: 100px;"  name="prd_code" value="<?=$prd_code?>"  />
			</div>
		</div>
		...
		<label class="control-label">Product name</label>
			<div class="controls">
			<input  type="text" id="txt" style="width: 250px;"  name="prd_name" value="<?=$prd_name?>"  />
			</div>
		</div>
		...
		<label class="control-label">Price </label>
			<div class="controls">
			<input  type="text" id="txt" style="width: 100px;"  name="prd_price" value="<?=$prd_price?>"  />
			</div>
		</div>
		...
		<label class="control-label">Color </label>
			<div class="controls">
			<input  type="text" id="txt" style="width: 150px;"  name="prd_color" value="<?=$prd_color?>"  />
			</div>
		</div>
		...
		<label class="control-label">Size </label>
			<div class="controls">
			<input  type="text" id="txt" style="width: 150px;"  name="prd_size" value="<?=$prd_size?>"  />
			</div>
		</div>
