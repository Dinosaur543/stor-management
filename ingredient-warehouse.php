...
<div id="ul-box">
  ...
  <?php  
      $q="SELECT * FROM warehouse Where wh_id_ingredient ='".$_GET['ID']."' ORDER BY wh_id ASC";  
  ...
  <?php  //	ถ้าNO DATA
      ...
      <table width="100%" border-collapse="collapse" background-color="#04AA6D" cellpadding="0" cellspacing="0" class="table table-condensed  table-bordered">
          <tr>
            <td width="12%" align="center" valign="middle" bgcolor="#F4F4F4" style="text-align:center;"><strong>Ingredient code</strong></td>
            <td width="31%" align="left" valign="middle" bgcolor="#F4F4F4" style="text-align:center;"><strong>Ingredient name </strong></td>
            ...
            <td width="6%" align="center" valign="middle" bgcolor="#F4F4F4" style="text-align:center;"><strong>Delete</strong></td>
                  ...
                  <!-- <td width="12%" align="center" valign="middle" bgcolor="#F4F4F4" style="text-align:center;"><strong>Exp date</strong></td> -->
...
<!--             <td width="14%" align="center" valign="middle" style="text-align:center;"><?=$wh_size?></td> -->
            ...
            <td width="7%" align="center" valign="middle" style="text-align:center;">
                <a href="expired-sess.php?sell=sess-register-exp&ID=<?=$ID?>">  Expired</a> </td>
            ...
            <td width="6%" align="center" valign="middle" style="text-align:center;"> 
                <a href="<?php echo $Action; ?>?Table=warehouset&Sql=Delete&ID=<?=$ID?>" onclick="return confirm('Confim to delete info <?=$name?> Logout')">  Delete</a>		  </td>
