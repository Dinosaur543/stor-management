<div id="selection">
	 ...
	 <!-- // ---------------------------------------------- // -->
		<label id="title-h2">Ingredient info</label> 
	 <!-- // ---------------------------------------------- // -->
	 
 	</div>
 
<?php  
	$q="SELECT * FROM ingredient ORDER BY ingredient_id ASC";  
...
<?php  //	ถ้าNO DATA
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-condensed  table-bordered">
        <tr>
          ...
          <td width="68%" align="left" valign="middle" bgcolor="#F4F4F4" style="text-align:center;"><strong>Ingredient </strong></td>
...
?>
        ...
        <tr class="report">
		  	...
		  	<td width="12%" align="center" valign="middle" style="text-align:center;">
		 		<a  href="main.php?stt=ingredient-edit&ID=<?=$ID?>"> Edit</a> </td>
          
			<td width="9%" align="center" valign="middle" style="text-align:center;"> 
		  		<a href="<?php echo $Action; ?>?Table=ingredient&Sql=Delete&ID=<?=$ID?>" onclick="return confirm('Confirm to delete info <?=$name?> Logout')">Delete</a>		  </td>
        </tr>
